...
let QuestionsService = class QuestionsService {
    ...
    getQuizzes() {
        return this.http.get(`../assets/quiz-list.json`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((results) => {
            return results.map(r => new _quiz_model__WEBPACK_IMPORTED_MODULE_4__["Quiz"](r.label, r.name, r.description, r.filename));
        }));
    }
